...
export function launchWidget(){return `<section class="launch-widget" aria-labelledby="launch-heading"><p class="launch-eyebrow">The full system launches together</p><h2 id="launch-heading" class="launch-kicker" data-launch-kicker>Nutrition.Fitness goes live in…</h2><div class="launch-clock" data-launch-clock role="timer" aria-live="off" aria-label="Time until the Nutrition.Fitness launch"><div><strong data-days>—</strong><span>Days</span></div><div><strong data-hours>—</strong><span>Hours</span></div><div><strong data-minutes>—</strong><span>Minutes</span></div></div><p class="launch-date"><time datetime="${LAUNCH.at}">${LAUNCH.label}</time></p><p class="launch-scope">NUFI+ · Programmes · Meal planning · Courses · Supplements</p></section>`;}
