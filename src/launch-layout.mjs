...
export function compileLaunchLayout(html,route){
 ...
 html=html.replace('</head>','<link rel="stylesheet" href="/launch.css"><link rel="stylesheet" href="/product-layout.css"><script type="module" src="/launch.mjs"></script><link rel="stylesheet" href="/form-modals.css"><script type="module" src="/form-modals.mjs"></script></head>');
