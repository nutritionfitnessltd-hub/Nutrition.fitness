...
import {compileLaunchLayout,launchWidget,renderFinder} from '../src/launch-layout.mjs';
...
for(const route of [...routes,{url:'/404/',file:'404.html'}]){
 ...
 if(route.url==='/'){
  ...
  html=html.replace(old,`${launchWidget()}<a class="button hero-button" href="/get-started/">Find my programme <svg><use href="#i-arrow"></use></svg></a><p class="launch-microcopy">Plus your first month of NUFI+, free.</p><a class="launch-secondary" href="/nufi/">Meet NUFI+ first →</a>`);
 }
